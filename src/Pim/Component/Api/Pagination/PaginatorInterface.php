...
interface PaginatorInterface
{
     ...
     * @param array  $options        options of the pagination, such as request parameters
     * @param int    $count          total number of items without pagination
     * @param string $routeList      route name of the collection
     * @param string $routeItemName  route name of the items in the collection
     * @param string $itemIdentifier identifier key of an item
     *
     * @return array
     */
    public function paginate(array $items, array $options, $count, $routeList, $routeItemName, $itemIdentifier);
}
